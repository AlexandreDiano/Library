...
class LoansTest < ApplicationSystemTestCase
  ...
  test "creating a Loan" do
    ...
    fill_in "Borrow books", with: @loan.borrow_books
    fill_in "Cpf", with: @loan.cpf
    fill_in "Returned books", with: @loan.returned_books
    fill_in "Total pending", with: @loan.total_pending
